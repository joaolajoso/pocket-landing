  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: "appearance-none bg-background border border-border rounded-md px-2 py-1 text-sm font-medium cursor-pointer hover:bg-accent focus:outline-none focus:ring-2 focus:ring-ring pointer-events-auto",
        dropdown_month: "mr-1",
        dropdown_year: "",
        vhidden: "hidden",
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 pointer-events-auto cursor-pointer"
        ),
