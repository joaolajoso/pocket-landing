...
const sheetVariants = cva(
  "fixed z-50 gap-4 p-6 shadow-2xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 bg-background/60 backdrop-blur-2xl backdrop-saturate-150",
  {
    variants: {
      side: {
